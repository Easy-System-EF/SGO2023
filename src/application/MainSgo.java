...
public class MainSgo extends Application {
...
*/
	...
	public void start(Stage primaryStage) { 
	  try { 
			...
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/MainViewSgo.fxml"));
			ScrollPane scrollpane = loader.load();
 			MainViewSgoController controller = loader.getController();
