...
public class Orcamento implements Serializable {
	...
	private Integer mesOrc;
	private Integer anoOrc;
	...
	public Orcamento(Integer numeroOrc, Date dataOrc, String clienteOrc, String funcionarioOrc, String placaOrc,
			...
			Integer osOrc, Integer mesOrc, Integer anoOrc, Cliente cliente, Funcionario funcionario, Veiculo veiculo, 
			OrcVirtual virtual) {
	...
	public Integer getMesOrc() {
		return mesOrc;
	}

	public void setMesOrc(Integer mesOrc) {
		this.mesOrc = mesOrc;
	}

	public Integer getAnoOrc() {
		return anoOrc;
	}

	public void setAnoOrc(Integer anoOrc) {
		this.anoOrc = anoOrc;
	}
	...
	public String dataFormatada() {
		...
		String data = sdf.format(dataOrc);
		return data;
	}
	...
	public String toString() {
		return "Orcamento [numeroOrc=" + numeroOrc + ", dataOrc=" + dataOrc + ", clienteOrc=" + clienteOrc
				...
				+ osOrc + ", mesOrc=" + mesOrc + ", anoOrc=" + anoOrc + ", cliente=" + cliente + ", funcionario="
				+ funcionario + ", veiculo=" + veiculo + ", virtual=" + virtual + "]";
	}
}
