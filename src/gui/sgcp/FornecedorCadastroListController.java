...
public class FornecedorCadastroListController implements Initializable, DataChangeListener {
...
// instanciando novo obj depto e injetando via
 		 ...
 		 createDialogForm(obj, "/gui/sgcp/FornecedorCadastroForm.fxml", parentStage);
  	}
...
*/ 	
	private synchronized void createDialogForm(Fornecedor obj, String absoluteName, Stage parentStage) {
		try {
		  ...
		  tableColumnEDITA.setCellFactory(param -> new TableCell<Fornecedor, Fornecedor>() { 
		    ...
		    protected void updateItem(Fornecedor obj, boolean empty) { 
		      ...
		      event -> createDialogForm( 
		        obj, "/gui/sgcp/FornecedorCadastroForm.fxml",Utils.currentStage(event)));
 		    } 
		  }); 
		}
