...
public class TipoConsumoCadastroListController implements Initializable, DataChangeListener {
...
// instanciando novo obj depto e injetando via
 		 ...
 		 createDialogForm(obj, "/gui/sgcp/TipoConsumoCadastroForm.fxml", parentStage);
...
*/ 	
	private synchronized void createDialogForm(TipoConsumo obj, String absoluteName, Stage parentStage) {
		try {
 			FXMLLoader loader  = new FXMLLoader(getClass().getResource(absoluteName));
			Pane pane = loader.load();
			
// referencia para o controlador = controlador da tela carregada fornListaForm			
			TipoConsumoCadastroFormController controller = loader.getController();
		  ...
		  tableColumnEDITA.setCellFactory(param -> new TableCell<TipoConsumo, TipoConsumo>() { 
		    ...
		    protected void updateItem(TipoConsumo obj, boolean empty) { 
		      ...
		      event -> createDialogForm( 
		        obj, "/gui/sgcp/TipoConsumoCadastroForm.fxml",Utils.currentStage(event)));
 		    } 
		  }); 
		}
