...
public class ClienteCadastroFormController implements Initializable {
...
// verifica se UFCli existe
		...
		if (textDdd01Cli.getText() == null || textDdd01Cli.getText().trim().contentEquals("")) {
...
//	 	//valida��o cpf / cnpj  	 	
 		...
 		if (rbFisica.isSelected()) {
 			Long cpf = Utils.tryParseToLong(textCpfCli.getText());
 			if (cpf == null) {
		...
		obj.setValorClass(0.00);
		obj.setPercentualClass(0.00);
		obj.setLetraClass(' ');
		obj.setVisitaClass(0);
...
//  string value of p/ casting int p/ string 		
 		...
 		if (entity.getDdd01Cli() == null) {
 			entity.setDdd01Cli(0);
 		}
 		textDdd01Cli.setText(String.valueOf(entity.getDdd01Cli()));
 		if (entity.getTelefone01Cli() == null) {
 			entity.setTelefone01Cli(0);
 		}
 		...
 		textTelefone02Cli.setText(String.valueOf(entity.getTelefone02Cli()));
  	 	...
  	 	Integer cpf = Utils.tryParseToInt(entity.getCpfCli());
