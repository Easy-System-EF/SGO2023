...
public class CargoCadastroListController implements Initializable, DataChangeListener {
...
// instanciando novo obj depto e injetando via
 		 Cargo obj = new Cargo();
 		 createDialogForm(obj, "/gui/sgo/CargoCadastroForm.fxml", parentStage);
   	}
...
*/ 	
	private synchronized void createDialogForm(Cargo obj, String absoluteName, Stage parentStage) {
		try {
 			FXMLLoader loader  = new FXMLLoader(getClass().getResource(absoluteName));
			Pane pane = loader.load();
			
// referencia para o controlador = controlador da tela carregada fornListaForm			
			CargoCadastroFormController controller = loader.getController();
		  ...
		  tableColumnEDITA.setCellFactory(param -> new TableCell<Cargo, Cargo>() { 
		    ...
		    protected void updateItem(Cargo obj, boolean empty) { 
		      ...
		      event -> createDialogForm( 
		        obj, "/gui/sgo/CargoCadastroForm.fxml",Utils.currentStage(event)));
 		    } 
		  }); 
		}
