...
public class AdiantamentoCadastroListController implements Initializable, DataChangeListener {
...
// instanciando novo obj depto e injetando via
         classe = "Adiantamento  Adi List";
 		 createDialogForm(obj, objFun, objCom, objPer, objPar, objTip,   "/gui/sgo/AdiantamentoCadastroForm.fxml", parentStage);
   	}
...
*/
	...
	private synchronized void createDialogForm(Adiantamento obj, Funcionario objFun, Compromisso objCom, 
...
// referencia para o controlador = controlador da tela carregada fornListaForm			
			AdiantamentoCadastroFormController controller = loader.getController();
