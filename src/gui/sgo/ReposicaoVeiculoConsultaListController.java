...
public class ReposicaoVeiculoConsultaListController implements Initializable, DataChangeListener {
...
// injeta a dependencia com set (invers�o de controle de inje�ao)	
 	...
 	public void onBtDadosAction(ActionEvent event) {
		...
		classe = "Reposição";
  		createDialogOpcao("/gui/sgo/ReposicaoDadosForm.fxml", (parentStage), 
