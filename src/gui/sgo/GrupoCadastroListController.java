...
public class GrupoCadastroListController implements Initializable, DataChangeListener {
...
// instanciando novo obj depto e injetando via
 		 Grupo obj = new Grupo();
 		 createDialogForm(obj, "/gui/sgo/GrupoCadastroForm.fxml", parentStage);
  	}
...
*/ 	
	private synchronized void createDialogForm(Grupo obj, String absoluteName, Stage parentStage) {
		try {
 			FXMLLoader loader  = new FXMLLoader(getClass().getResource(absoluteName));
			Pane pane = loader.load();
			
// referencia para o controlador = controlador da tela carregada fornListaForm			
			GrupoCadastroFormController controller = loader.getController();
		  ...
		  tableColumnEDITA.setCellFactory(param -> new TableCell<Grupo, Grupo>() { 
		    ...
		    protected void updateItem(Grupo obj, boolean empty) { 
		      ...
		      event -> createDialogForm( 
		        obj, "/gui/sgo/GrupoCadastroForm.fxml",Utils.currentStage(event)));
 		    } 
		  }); 
		}
