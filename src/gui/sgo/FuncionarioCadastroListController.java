...
public class FuncionarioCadastroListController implements Initializable, DataChangeListener {
...
// instanciando novo obj depto e injetando via
 		 ...
 		 createDialogForm(obj, "/gui/sgo/FuncionarioCadastroForm.fxml", parentStage);
   	}
...
*/
	private synchronized void createDialogForm(Funcionario obj, String absoluteName, Stage parentStage) {
		try {
		  ...
		  tableColumnEDITA.setCellFactory(param -> new TableCell<Funcionario, Funcionario>() { 
		    ...
		    protected void updateItem(Funcionario obj, boolean empty) { 
		      ...
		      event -> createDialogForm( 
		        obj, "/gui/sgo/FuncionarioCadastroForm.fxml",Utils.currentStage(event)));
 		    } 
		  }); 
		}	
}
