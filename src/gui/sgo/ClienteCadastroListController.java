...
public class ClienteCadastroListController implements Initializable, DataChangeListener {
...
// instanciando novo obj depto e injetando via
 		 ...
 		 createDialogForm(obj, "/gui/sgo/ClienteCadastroForm.fxml", parentStage);
  	}
...
*/ 	
	private synchronized void createDialogForm(Cliente obj, String absoluteName, Stage parentStage) {
		try {
	...
	private void initEditButtons() {
		  ...
		  tableColumnEDITA.setCellFactory(param -> new TableCell<Cliente, Cliente>() { 
		    ...
		    protected void updateItem(Cliente obj, boolean empty) { 
		      ...
		      setGraphic(button); 
		      button.setOnAction(event -> createDialogForm(obj, "/gui/sgo/ClienteCadastroForm.fxml", Utils.currentStage(event)));
 		    } 
		  }); 
		}
